      ...
      <transition name="move">
        <div class="shopcart-list" v-show="listShow">
          ...
          <div class="list-content">
            <ul>
              <li class="food" v-for="(shopFood,index) in shopCart">
                <span class="name">{{shopFood.name}}</span>
                <div class="price"><span>￥{{shopFood.price}}</span></div>
                <div class="cartcontrol-wrapper">
                  <CartControl :food="shopFood"/>
                </div>
              </li>
            </ul>
          </div>
  ...
  import {MessageBox} from 'mint-ui'
    ...
    data(){
      ...
      listShow(){
        ...
        if(this.isShow){
          this.$nextTick(() => {
            if(!this.scroll){//创建一个单例，否则每次都会创建一个，因为better-scroll不是按照原生写的，实例中的方法会触发多次
